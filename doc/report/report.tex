...
Im Rahmen des Projekts erweiterten wir den Sprachumfang von SL um folgende
Features:

\begin{description}
 \item[Export von Bezeichnern]
 \item[Import von Modulen] 
 \item[Qualifizierte Bezeichner] blubb
 \item[Externe Definitionen] blubb
 \item[Externe Datentypen] blubb
 \item[Import von JavaScript-Code] blubb
\end{description}

Für die neuen Konstrukte besprechen wir die Syntax genauer in Abschnitt~\ref{sec:syntax},
die semantische Analyse in Abschnitt~\ref{sec:semantics} und die
Codegenerierung in Abschnitt~\ref{sec:codegen}.

Darüber hinaus widmeten wir uns auch noch weiteren Themen:

\begin{description}
 \item[Syntaxanpassungen] blubb
 \item[Compilationdriver] blubb
 \item[Fehlermeldungen] blubb
 \item[Prelude] blubb
 \item[Libraries] blubb
 \item[Beispielprogramme] blubb
 \item[Tests] blubb
\end{description}
