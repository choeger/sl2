...
lexikalische Struktur ist in Abbildung~\ref{grm:lex} aufgelistet.
Nicht erwähnt darin sind die Kommentare und Operator-Präzedenzen.  SL
folgt bei den Kommentaren der Tradition von Haskell; es gibt also
einerseits Zeilenkommentare, die mit \verb|--| eingeleitet werden,
andererseits auch Blockkommentare, die von \verb:{-: und \verb:-}:
eingeschlossen werden. Die Päzedenzen sind in der folgenden Tabelle
aufgelistet:
\begin{center}
\begin{tabular}{clc}
...
Die JavaScript-Dateien der einzelnen Module werden aus
